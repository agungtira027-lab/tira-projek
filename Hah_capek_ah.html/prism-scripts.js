        ...
        const portfolioData = [
            {
                ...
                description: 'Sistem kecerdasan buatan (AI) canggih dengan kemampuan pembelajaran mendalam (deep learning) untuk analisis prediktif dan pengenalan pola.',
                image: 'neural-network1.jpg',
                tech: ['TensorFlow', 'Python', 'CUDA']
            },
            {
                id: 2,
                title: 'Quantum Cloud',
                description: 'Infrastruktur cloud generasi berikutnya yang memanfaatkan komputasi kuantum untuk daya pemrosesan yang belum pernah ada sebelumnya.',
                image: 'quantum-cloud1.jpg',
                tech: ['AWS', 'Kubernetes', 'Docker']
            },
            {
                id: 3,
                title: 'Blockchain Vault',
                description: 'Solusi penyimpanan terdesentralisasi yang aman menggunakan enkripsi canggih dan teknologi ledger terdistribusi.',
                image: 'Blockchain Vault1.jpg',
                tech: ['Ethereum', 'Solidity', 'Web3']
            },
            {
                id: 4,
                title: 'Cyber Defense',
                description: 'Kerangka kerja keamanan siber tingkat militer dengan deteksi ancaman secara real-time dan respons otomatis.',
                image: 'Cyber Defense1.jpg',
                tech: ['Zero Trust', 'AI Defense', 'Encryption']
            },
            {
                id: 5,
                title: 'Data Nexus',
                description: 'Platform pemrosesan big data yang mampu menganalisis petabytes data secara real-time.',
                image: 'Data Nexus1.jpg',
                tech: ['Apache Spark', 'Hadoop', 'Kafka']
            },
            {
                id: 6,
                title: 'AR Interface',
                description: 'Sistem realitas tertambah untuk visualisasi data yang imersif dan pengalaman interaktif.',
                image: 'AR Interface1.jpg',
                tech: ['Unity', 'ARCore', 'Computer Vision']
            },
            {
                id: 7,
                title: 'IoT Matrix',
                description: 'Ekosistem IoT cerdas yang menghubungkan jutaan perangkat dengan kemampuan komputasi tepi.',
                image: 'IoT Matrix1.jpg',
        ...
        function createCarouselItem(data, index) {
            ...
            item.innerHTML = `
                <div class="card">
                    ...
                    <button class="card-cta" onclick="scrollToSection('about')">Jelajahi</button>
                </div>
            `;
